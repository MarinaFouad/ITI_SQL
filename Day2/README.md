...
Notes:
-	The Participation of the branch in the Branch-Employee relation could be may or must.
-	The attributes (from, to) on Employee entity cannot be joined in one attribute, in order to calculate the “duration” derived attribute.
...
Notes:
-	The Participation of Branch in the branch-staff relation could be May or Must.
-	Address and Datetime of the order could be attributes on the Order Entity or on the Relatioship between Order and Customer.
...
Note: “Allergies” and “Diseases” can be combined into one multi-valued attribute.
